                ...
                <div className="bg-white rounded-lg border px-3">
                    <ScrollArea>
                        <TabsList className="p-0 bg-background justify-start rounded-none h-13">
                            <TabsTrigger 
                            value="summary"
                            className="text-muted-foreground data-[state=active]:shadow-none data-[state=active]:border-b-primary rounded-none bg-background border-b-2 border-transparent data-[state=active]:text-accent-foreground h-full hover:text-accent-foreground"
                            >
                                <BookOpenTextIcon />
                                Summary
                            </TabsTrigger>
